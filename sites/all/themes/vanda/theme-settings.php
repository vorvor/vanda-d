 ...
 */
function vanda_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['vanda_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('vanda sample setting'),
  '#default_value' => theme_get_setting('vanda_example'),
